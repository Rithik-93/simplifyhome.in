...
const UserDetailsStep: React.FC<UserDetailsStepProps> = ({ 
  ...
  return (
    <div className="w-full mx-auto px-4">
      <div className="bg-white rounded-xl shadow-xl p-6 border-2 border-yellow-400 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-yellow-200 focus:border-yellow-400 transition-all duration-200 text-base"
              style={{ 
        ...
        {/* Privacy Notice */}
        <div className="mt-6 bg-yellow-50 rounded-xl p-4 border-2 border-yellow-400">
        ...
        {/* Benefits Section */}
        <div className="mt-4 bg-black rounded-xl p-4 border-2 border-yellow-400">
